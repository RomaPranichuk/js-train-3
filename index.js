...
function isAlmostSame(num1, num2) {
  let result = num1 - num2 <= Number.EPSILON && num2 - num1 <= Number.EPSILON;
  return result;
}
...
function isSafeInteger(num) {
  let result = num >= Number.MAX_SAFE_INTEGER <= Number.MIN_SAFE_INTEGER;
  return result;
}
...
function isAlmostZero(num) {
  let result = num > Number.MIN_VALUE;
  return result;
}
